    ...
    return (
        ...
        <div className="Coll">
            ...
            <div className="Coll_body">
                ...
                <div className="Coll_block" onClick={()=>  localStorage.setItem('Category',"Travel")}>
