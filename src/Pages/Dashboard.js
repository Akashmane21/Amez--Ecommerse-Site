        ...
        <Slide top>
          <div className="logot">
            ...
            <button onClick={Logout}>
              Logout_<i class="fa fa-sign-out" aria-hidden="true"></i>
            </button>
          </div>
        </Slide>
        <LightSpeed left>
        ...
        <div className="boxesss">
          <Zoom left>
            <div className="box" onClick={() => setisAdd(!isAdd)}>
              <a href="#Add">
                {" "}
                <img
                  src="https://st3.depositphotos.com/1915171/32517/v/950/depositphotos_325177164-stock-illustration-add-shopping-cart-line-icon.jpg"
                  alt=" "
                />
          ...
          <Zoom bottom>
            <div className="box" onClick={() => setisProducts(!isProducts)}>
              <a href="#Shop">
                {" "}
                <img
                  src="https://previews.123rf.com/images/abscent/abscent1706/abscent170600068/80125240-paper-shopping-bag-full-of-groceries-products-grocery-store-supermarket-fresh-organic-food-and-drink.jpg"
                  alt=" "
                />
                <h3> Your Products</h3>
              </a>
          ...
          <Zoom right>
            <div className="box" onClick={() => history.push("/")}>
              <img
                src="https://static.vecteezy.com/system/resources/previews/001/222/484/non_2x/e-commerce-online-shopping-concept-vector.jpg"
                alt=" "
              />
              ...
              <div class="sec">
                ...
                <div class="gg">
                  <select name="mySelect" id="mySelect">
                    ...
                    <option value="Home" className="item">
                      Home
                    </option>
                    <option value="Fashion" className="item">
                      Fashion
                    </option>
                    <option value="Electronics" className="item">
                      Electronics
                    </option>
                    <option value="Mobiles" className="item">
                      Mobiles
                    </option>
                    <option value="Dresses" className="item">
                      Dresses
                    </option>
                    <option value="Shoes" className="item">
                      Shoes
                    </option>
                    <option value="Watches" className="item">
                      Watches
                    </option>
                    <option value="Appliances" className="item">
                      Appliances
                    </option>
                    <option value="Kids" className="item">
                      Kids
                    </option>
                    <option value="Books" className="item">
                      Books
                    </option>
                  </select>
                </div>
