    ...
    <div className="App">
      ...
      <div className="Packblock">
        <div className="Packleft_area">
          <Fade left>
            <lottie-player
              src="https://assets7.lottiefiles.com/packages/lf20_99VKMQ.json"
        ...
        <div className="Packright_area">
          ...
          <div className="data">
            <div>
              <h2>Name :</h2>
              <input
                placeholder="Ener your Name here"
                required
          ...
          <textarea
            rows={3}
            placeholder="Enter your Address here with pin-code"
          ...
          <button className="place" onClick={Submit}>
            Place Order
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="35"
